  ...
  return (
    <div className='shadow-lg rounded-lg relative h-full hover:shadow-2xl transition-shadow duration-500'>
        ...
        <div className='p-6 pb-2 space-y-1'>
            ...
            <p>{ticketsRemaining}</p>

            <div className='absolute bottom-0 right-0 size-8 bg-blue-600 flex items-center justify-center text-white rounded-tl-lg rounded-br-lg'>
              <FaArrowRightLong />
            </div>
