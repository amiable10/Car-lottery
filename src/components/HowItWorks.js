...
const HowItWorks = () => {
    return ( 
      ...
      <section className="w-full flex justify-center items-center pb-40 HowItWorks">
                ...
                <Bounce>
                  {
                    steps.map((item, index)=> (
                        <li className="w-full flex flex-col sm:flex-row key={index}">
                            ...
                            <div className={`p-4 pt-8 flex sm:hidden lg:flex justify-center lg:justify-start rotate-90 sm:rotate-0 ${index === steps.length - 1 ? "hidden lg:hidden" : ""}`}>
